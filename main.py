...
async def analizar_cv(pdf_url: str, puesto_postular: str,  original_name: str,):
   ...
   # print("filename_response", filename_response)
    ...
    resultados = {
        ...
        "habilidades_herramientas": clean_and_load_json(habilidades_herramientas)['recomendaciones'],
        "educacion": clean_and_load_json(educacion),
        "voluntariado": voluntariado_json,
        "formato-optimizacion": clean_and_load_json(formato_optimizacion),
        ...
        "extractedData": {
            ...
            "extractedData": { 
                ...
                "workExperience": experiencia_laboral_json,
